        ...
        >
          ...
          <div className="relative w-full h-40 sm:h-full sm:w-36 md:w-40 lg:w-44 shrink-0 group py-6 px-2">
            <img 
              src={food.image} 
              alt={food.name} 
              className="w-full h-40 sm:h-40 object-cover transition-transform duration-300 group-hover:scale-105 rounded-lg" 
            />
            ...
            {/* Add Button */}
            <button 
              className="absolute bottom-2 right-2 sm:bottom-2 sm:right-11 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white px-4 py-1.5 sm:px-5 sm:py-2 rounded-md text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 z-10"
